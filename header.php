...
<link rel='stylesheet' id='datatables-demo-css' href='http://www.datatables.net/release-datatables/media/css/demo_table.css?ver=3.1' type='text/css' media='all'/>
TTTTTTTT
...
TTTTTTTT
			    ...
			    <?php if (get_option('colorway_topright_cell') != '') { ?>
                                   <p class="cell"><img src="<?php echo get_template_directory_uri(); ?>/images/call-us.png" alt="Call us"  class="call-us" />&nbsp; <?php echo stripslashes(get_option('colorway_topright_cell')); ?></p>
                                    <?php } else { ?>
                  <p class="cell"><img src="<?php echo get_template_directory_uri(); ?>/images/call-us.png" alt="Call us"  class="call-us" />&nbsp;Bizi Arayın (212) 210 - 9692</p>
				  <?php } ?>
				  <?php if (get_option('colorway_topright_text') != '') { ?>
                                    <p><?php echo stripslashes(get_option('colorway_topright_text')); ?></p>
                                    <?php } else { ?>
                  <p>Perpa B-Blok K:5 No:187, Şişli-İSTANBUL</p>
					<?php } ?>
